      ...
      body: Stack(children: [
        Positioned(
            ...
            child: Container(
              ...
              child: isLoading ? Center(child: Container(height:50, width: 50,child: CircularProgressIndicator())) : _buildInfoMenu(),
            ))
      ]),
    );
  }
  ...
  Column _buildInfoMenu() {
    return Column(
              ...
              children: [
                ...
                Container(width: 150, height: 150, child: user.avatar != null ?CircleAvatar(
                  backgroundImage:   NetworkImage("${AppConfig.IMAGE_API_URL}${user.avatar as String}") ,
                ) : CircleAvatar()
                ),
                const SizedBox(
                  height: 10,
                ...
                Text(
                  user.is_philanthropist != null && user.is_philanthropist != false ? 'Nhà từ thiện' : 'Người dùng',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
  ...
  Widget _menu() {
    return Column(
      ...
      children: [
        InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateInfoPage(user: user,callback:  () async => await _getInfo(),)));
          },
        ...
        InkWell(
          onTap: () {
            ...
            child: _menuItem(Icons.logout_outlined, 'Đăng xuất', Color(0xFFFF9900))),
      ],
    );
  }
