...
class _EditProductPageState extends State<EditProductPage> {
  ...
  late String _genderController = "Nam";
  String _typeProductController = '';
  List<String> _sizeController = [];
  late TextEditingController _nameController = TextEditingController(text: widget.product.name.toString());
  late TextEditingController _priceController = TextEditingController(text: widget.product.price.toString());
  late TextEditingController _quantityController = TextEditingController(text: widget.product.quantity.toString());
  late TextEditingController _descriptionController = TextEditingController(text: widget.product.description.toString());
  ...
  void initState() {
    super.initState();
    _page = 1;
    _degreeController = widget.product.degree!;
    _genderController = widget.product.gender!;
    _typeProductController = widget.product.productType.toString();
    _sizeController = widget.product.size!.split(', ');
  }


  Future<List<ProductType>> _getType() async {
    return await ProductRequest.getProductType();
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: ShapeDecoration(
          color: _degreeController == gender
              ? Colors.black
              : Colors.white,
  ...
  Widget genderButton(String gender) {
    return InkWell(
      onTap: () {
        setState(() {
          // print(_genderController.compareTo(gender));
      ...
      child: Container(
        padding: EdgeInsets.symmetric(vertical: 20),
        decoration: ShapeDecoration(
          color: _genderController.compareTo(gender) == 0
              ? Colors.black
              : Colors.white,
          shape: RoundedRectangleBorder(
            side: BorderSide(color: Color(0xFF999999)),
